...
struct IVector2D {
	...
	const static IVector2D up;
	/** A vector pointing down (0,-1) */
	const static IVector2D down;
	/** A vector pointing north (1,0) */
	const static IVector2D right;
	/** A vector pointing south (-1,0) */
	const static IVector2D left;
	...
	*/
	 ...
	 */
	void set(const IVector2D& OtherVector);
	 ...
	 */
	IVector2D operator+(const IVector2D& OtherVec) const;
	 ...
	 * @return The resulting vector
	 */
	IVector2D operator+(int Amount) const;
	 ...
	 * @return The resulting vector
	 */
	IVector2D operator*(int Value) const;
	 ...
	 */
	bool operator<(const IVector2D& OtherVec) const;
	 ...
	 */
	bool equals(const IVector2D& OtherVec) const;
